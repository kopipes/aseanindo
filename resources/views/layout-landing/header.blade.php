<nav class="bg-white shadow-md fixed top-0 w-full z-50 font-ubuntu">
        ...
        <ul class="hidden lg:flex space-x-8 items-center">
            ...
            <li class="relative group">
                ...
                <div id="dropdown-menu-produk"
                    ...
                    <ul class="space-y-4">
                        <li><a href="/product/ai-qa-scoring"
                                class="{{ Request::is('product/ai-qa-scoring') ? 'font-semibold' : 'text-darkblue font-medium hover:font-semibold' }} relative">AI
                                QA Scoring</a></li>
                        ...
                        <li><a href="/product/automation-customer-service"
                                class="{{ Request::is('product/automation-customer-service') ? 'font-semibold' : 'text-darkblue font-medium hover:font-semibold' }} relative">Customer
    ...
    <div id="mobile-menu" class="lg:hidden menu-hidden bg-white p-4 shadow-md">
        <ul class="space-y-4">
            <li><a href="/"
                    class="{{ Request::is('/') ? 'text-darkblue font-semibold' : 'text-gray-600 hover:text-darkblue hover:font-semibold font-medium' }}">Beranda</a>
            </li>
            <li class="relative">
                <button id="mobile-product-btn"
                    ...
                    <a href="/product"
                        class="{{ Request::is('product*') ? 'text-darkblue font-semibold' : 'text-gray-600 hover:text-darkblue hover:font-semibold font-medium' }}">Produk</a>
                    <i class="fas fa-chevron-down"></i>
                </button>
                <ul id="mobile-product-menu" class="hidden space-y-2 mt-2">
                    <li><a href="/product/ai-qa-scoring"
                            class="{{ Request::is('product/ai-qa-scoring') ? 'text-darkblue font-semibold' : 'text-gray-600 hover:text-darkblue hover:font-semibold font-medium' }}">AI
                            QA Scoring</a></li>
                    <li><a href="/product/contact-center-software"
                            class="{{ Request::is('product/contact-center-software') ? 'text-darkblue font-semibold' : 'text-gray-600 hover:text-darkblue hover:font-semibold font-medium' }}">Contact
                            Center Software</a></li>
                    <li><a href="/product/omnichannel-contact-center"
                            ...
                            Contact Center</a></li>
                    <li><a href="/product/self-service-contact-center"
                            class="{{ Request::is('product/self-service-contact-center') ? 'text-darkblue font-semibold' : 'text-gray-600 hover:text-darkblue hover:font-semibold font-medium' }}">Self
                            Service Contact Center</a></li>
                    <li><a href="/product/ticketing-management-system"
                            class="{{ Request::is('product/ticketing-management-system') ? 'text-darkblue font-semibold' : 'text-gray-600 hover:text-darkblue hover:font-semibold font-medium' }}">Ticketing
                            Management System</a></li>
                    <li><a href="/product/features-and-benefits"
                            class="{{ Request::is('product/features-and-benefits') ? 'text-darkblue font-semibold' : 'text-gray-600 hover:text-darkblue hover:font-semibold font-medium' }}">Feature
                            and
                            Benefits</a></li>
                    <li><a href="/product/automation-customer-service"
                            class="{{ Request::is('product/automation-customer-service') ? 'text-darkblue font-semibold' : 'text-gray-600 hover:text-darkblue hover:font-semibold font-medium' }}">Customer
                            Service Automation</a></li>
                    <li><a href="/product/workforce-performance"
                            class="{{ Request::is('product/workforce-performance') ? 'text-darkblue font-semibold' : 'text-gray-600 hover:text-darkblue hover:font-semibold font-medium' }}">Workforce
                            Performance</a></li>
                    <li><a href="/product/sdm-outsourcing"
                            class="{{ Request::is('product/sdm-outsourcing') ? 'text-darkblue font-semibold' : 'text-gray-600 hover:text-darkblue hover:font-semibold font-medium' }}">SDM
                            Outsourcing</a></li>
                </ul>
            </li>
            <li><a href="/about"
                    class="{{ Request::is('about') ? 'text-darkblue font-semibold' : 'text-gray-600 hover:text-darkblue hover:font-semibold font-medium' }}">Perusahaan</a>
            </li>
            <li><a href="/blog"
                    class="{{ Request::is('blog') ? 'text-darkblue font-semibold' : 'text-gray-600 hover:text-darkblue hover:font-semibold font-medium' }}">Artikel</a>
            </li>
            <li><a href="/contact"
                    class="{{ Request::is('contact') ? 'text-darkblue font-semibold' : 'text-gray-600 hover:text-darkblue hover:font-semibold font-medium' }}">Hubungi
                    kami</a></li>
            <li><a href="/faq"
                    class="{{ Request::is('faq') ? 'text-darkblue font-semibold' : 'text-gray-600 hover:text-darkblue hover:font-semibold font-medium' }}">Bantuan</a>
            </li>
