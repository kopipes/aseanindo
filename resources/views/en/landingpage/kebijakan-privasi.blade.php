...
@section('content')
    <div class="relative bg-cover bg-center h-96"
        style="background-image: url('/img/rebranding/kebijakan-privasi-banner.webp');">
        <div class="relative max-w-7xl mx-auto h-full flex items-center justify-center text-center px-4 md:px-8">
            <div class="text-white">
                <h1 class="text-4xl md:text-6xl font-bold mb-6 font-montserrat">Privacy Policy</h1>
                <ul class="decoration-none flex flex-row gap-2 justify-center font-ubuntu">
                    ...
                    <li><a href="/en/privacy-policy" class="hover:text-slate-200">Privacy Policy</a></li>
                </ul>
            </div>
        </div>
