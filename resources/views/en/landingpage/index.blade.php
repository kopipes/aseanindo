...
@section('content')
        ...
        <div class="lg:w-1/2 space-y-4 animate-fade-in-left-bounce">
            ...
            <ul class="space-y-4">
                ...
                <li class="flex items-center">
                    ...
                    <div class="max-w-md">
                        <p class="text-lg text-gray-600"><span class="font-bold text-slate-900">Free Calls:</span>
                            Call the contact center without any cost (with internet connection).</p>
                    </div>
                </li>
                ...
                <li class="flex items-center">
                    ...
                    <div class="max-w-md">
                        <p class="text-lg text-gray-600"><span class="font-bold text-slate-900">Flexible Chat:</span>
                            Communicate directly through chat if you prefer not to call.</p>
                    </div>
                </li>
                ...
                <li class="flex items-center">
                    ...
                    <div class="max-w-md">
                        <p class="text-lg text-gray-600"><span class="font-bold text-slate-900">Callback:</span>
                            If customer service is busy, we will get back to you.</p>
                    </div>
                </li>
                ...
                <li class="flex items-center">
                    ...
                    <div class="max-w-md">
                        <p class="text-lg text-gray-600"><span class="font-bold text-slate-900">Location Sharing:</span>
                            Easily share your location through chat.</p>
                    </div>
                </li>
                ...
                <li class="flex items-center">
                    ...
                    <div class="max-w-md">
                        <p class="text-lg text-gray-600"><span class="font-bold text-slate-900">Access Products:</span>
                            Explore your favorite products and services on KontaKami.</p>
                    </div>
                </li>
                ...
                <li class="flex items-center">
                    ...
                    <div class="max-w-md">
                        <p class="text-lg text-gray-600"><span class="font-bold text-slate-900">Fast Connection:</span>
                            Connect directly with customer service without delay.</p>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <div class="max-w-7xl mx-auto py-16 px-4 md:px-8 flex flex-col justify-center items-center">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 animate-bounce-in max-w-5xl">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 text-left hover:shadow-2xl transition-all duration-200">
                ...
                <p class="text-gray-600 font-ubuntu">
                    Send targeted messages and mass marketing campaigns via WhatsApp to reach more customers.
                </p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 text-left hover:shadow-2xl transition-all duration-200">
                ...
                <p class="text-gray-600 font-ubuntu">
                    Monitor and manage escalations with measurable service agreements, ensuring KPIs are effectively met.
                </p>
            </div>
    ...
    <div class="max-w-7xl mx-auto py-16 px-4 md:px-8 flex flex-col justify-center items-center">
        ...
        <div class="flex flex-col items-center justify-center gap-8 max-w-5xl">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 flex flex-col md:flex-row gap-4 justify-center items-center">
                <img src="/img/rebranding/callback.gif" alt="Call Back" class="rounded-md mb-6">
                <div>
