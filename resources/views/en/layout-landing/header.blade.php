<nav class="bg-white shadow-md fixed top-0 w-full z-50 font-ubuntu">
    <div class="container mx-auto px-4 lg:px-8 flex justify-between items-center py-4">
        <div class="flex items-center space-x-2">
            <a href="/en"><img src="{{ asset('img/rebranding/logokontakami.svg') }}" alt="logo" class="w-full h-7"></a>
        </div>
        ...
        <ul class="hidden lg:flex space-x-8 items-center">
            <li>
                <a href="{{ localized_url() }}"
                    class="{{ Request::is('en') ? 'text-darkblue font-semibold underline' : 'text-gray-600 hover:text-darkblue hover:underline font-medium' }}">
                    Home
                </a>
            </li>

            <li class="relative group">
                <a href="{{ localized_url('product') }}"
                    class="{{ Request::is('en/product*') ? 'text-darkblue font-semibold underline' : 'text-gray-600 hover:text-darkblue hover:underline font-medium' }} relative"
                ...
                <div id="dropdown-menu-produk"
                    ...
                    <ul class="space-y-4">
                        ...
                        <li><a href="/en/product/omnichannel-contact-center"
                                class="{{ Request::is('en/product/omnichannel-contact-center') ? 'font-semibold' : 'text-darkblue font-medium hover:font-semibold' }} relative">Omnichannel
                                Contact Center</a></li>
                        <li><a href="/en/product/self-service-contact-center"
                                class="{{ Request::is('en/product/self-service-contact-center') ? 'font-semibold' : 'text-darkblue font-medium hover:font-semibold' }} relative">Self
                                Service Contact Center</a></li>
                        <li><a href="/en/product/ticketing-management-system"
                                class="{{ Request::is('en/product/ticketing-management-system') ? 'font-semibold' : 'text-darkblue font-medium hover:font-semibold' }} relative">Ticketing
                        ...
                        <li><a href="/en/product/sdm-outsourcing"
                                class="{{ Request::is('en/product/sdm-outsourcing') ? 'font-semibold' : 'text-darkblue font-medium hover:font-semibold' }} relative">SDM
                                Outsourcing</a></li>
                    </ul>
                </div>
            </li>
            ...
            <li>
                <a href="/en/about"
                    class="{{ Request::is('en/about') ? 'text-darkblue font-semibold underline' : 'text-gray-600 hover:text-darkblue hover:underline font-medium' }}">
                    Company
                </a>
            </li>
            ...
            <li>
                <a href="/en/blog"
                    class="{{ Request::is('en/blog') ? 'text-darkblue font-semibold underline' : 'text-gray-600 hover:text-darkblue hover:underline font-medium' }}">
                    Article
                </a>
            </li>
            <li>
                <a href="/en/contact"
                    class="{{ Request::is('en/contact') ? 'text-darkblue font-semibold underline' : 'text-gray-600 hover:text-darkblue hover:underline font-medium' }}">
                    Contact Us
                </a>
            </li>
            <li>
                <a href="/en/faq"
                    class="{{ Request::is('en/faq') ? 'text-darkblue font-semibold underline' : 'text-gray-600 hover:text-darkblue hover:underline font-medium' }}">
                    Help
                </a>
            </li>
        </ul>
