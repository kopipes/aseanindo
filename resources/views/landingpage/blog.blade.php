...
@section('title')
    <title>Informasi Seputar Layanan Pelanggan dan Bisnis - Kontakami </title>
@endsection()
@section('seo')
    <meta name="description" content="Blog yang membahas seputar layanan pelanggan dan tips di dunia bisnis dari Kontakami.">
    <link rel="canonical" href="https://kontakami.com/blog" />
@endsection()
    ...
    <div class="flex flex-col md:flex-row gap-4 max-w-6xl mx-auto mt-[10rem] md:mt-32">
        <div class="px-4">
            <div class="max-w-xs mx-auto animate-fade-in-left-bounce">
                ...
                <div>
                    <h3 class="text-lg font-bold text-blue-800 mb-4 font-montserrat">Kategori</h3>
                    <ul class="space-y-2">
                        ...
                        <li><button onclick="filterByCategory('Informasi')"
                                class="text-blue-700 font-medium hover:underline font-ubuntu">Informasi</button></li>
                        <li><button onclick="filterByCategory('Berita')"
                                class="text-blue-700 font-medium hover:underline font-ubuntu">Berita</button></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="w-full font-ubuntu">
            <div id="latest-article" class="max-w-5xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden flex p-6 mb-8 md:flex-row flex-col gap-4">
                ...
                <div class="ml-6 flex flex-col items-start justify-between">
                    <span
                        class="inline-block bg-orange text-white text-xs px-3 py-1 rounded-full uppercase font-semibold tracking-wide mb-2 font-ubuntu">Artikel
                        Terbaru</span>
                    <div>
    ...
    if (filteredArticles.length > 0) {
        ...
        document.getElementById("latest-article").innerHTML = `
            ...
            <div class="ml-6 md:w-1/2 flex flex-col items-start justify-between animate-fade-in-left-bounce">
                <span class="inline-block bg-orange text-white text-xs px-3 py-1 rounded-full uppercase font-semibold tracking-wide mb-2">Artikel Terbaru</span>
                <div>
