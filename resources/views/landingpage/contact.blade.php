...
@section('title')
    <title>Hubungi Kami - Kontakami</title>
@endsection()
@section('seo')
    <meta name="description" content="Hubungi kami sekarang juga, dan dapatkan konsultasi gratis seputar produk contact center, call center, dan platform untuk meningkatkan layanan pelanggan.">
    <link rel="canonical" href="https://kontakami.com/contact" />
@endsection()
...
<div class="relative bg-cover bg-center h-96" style="background-image: url('/img/rebranding/contact-banner.webp');">
    <div class="relative max-w-7xl mx-auto h-full flex items-center justify-center text-center px-4 md:px-8">
        <div class="text-white animate-fade-in-left-bounce">
            <h1 class="text-4xl md:text-6xl font-bold mb-6 font-montserrat">Hubungi Kami</h1>
            <ul class="decoration-none flex flex-row items-center justify-center gap-2 font-ubuntu">
                ...
                <li><a href="/contact" class="hover:text-slate-200">Hubungi Kami</a></li>
            </ul>
        </div>
    </div>
...
<div class="max-w-7xl mx-auto py-16 px-4 md:px-8">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
        <div class="bg-gray-100 rounded-2xl shadow-lg p-8 mt-8">
            ...
            <h3 class="text-lg font-bold text-darkblue mb-2 font-montserrat">No. Telepon</h3>
        ...
        <div class="bg-gray-100 rounded-2xl shadow-lg p-8 mt-8">
            ...
            <h3 class="text-lg font-bold text-darkblue mb-2 font-montserrat">Alamat</h3>
...
<div class="max-w-4xl mx-auto text-center py-12">
    <h2 class="text-3xl font-bold text-gray-900 mb-4 font-montserrat">Hubungi Kami di Sini</h2>
    <p class="text-gray-600 font-ubuntu">Kami siap membantu Anda! Untuk pertanyaan, dukungan, atau informasi lebih lanjut, silakan hubungi kami melalui saluran komunikasi yang tersedia.</p>
</div>
...
<div class="max-w-4xl mx-auto py-12 font-ubuntu px-4">
    @if(session('success'))
        <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4">
            ...
            <span class="block sm:inline">Terima kasih atas pesan anda. Tim kami akan menghubungi anda secepatnya</span>
        </div>
    @endif
    ...
    <form action="{{ route('contact.send') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-4">
        @csrf
        <!-- Nama -->
        <input type="text" name="name" placeholder="Nama" class="p-4 bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange" required />

        <!-- Email -->
        <input type="email" name="email" placeholder="Alamat Email" class="p-4 bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange" required />

        <!-- Kode Negara -->
        <input type="text" name="country_code" placeholder="Kode Negara" class="p-4 bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange" />

        <!-- Nomor Telepon -->
        <input type="text" name="number" placeholder="No. Telepon" class="p-4 bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange" />

        <!-- Perusahaan -->
        <input type="text" name="company" placeholder="Nama Perusahaan" class="md:col-span-2 p-4 bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange" />

        <!-- Pesan -->
        <textarea name="message" placeholder="Pesan" rows="5" maxlength="200"
