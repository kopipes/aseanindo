...
class Carousel {
    constructor(el) {
        ...
        this.carouselData = [
            {
                id: "1",
                src: "/assets/images/slider_fitur_1.png",
            },
            {
                id: "2",
                src: "/assets/images/slider_fitur_2.png",
            },
            {
                id: "3",
                src: "/assets/images/slider_fitur_3.png",
            },
            // {
            //     id: "4",
            //     src: "/assets/images/banner-fitur-webcall-1.png",
            // },
            // {
            //     id: "5",
            //     src: "/assets/images/banner-fitur-webcall-1.png",
    ...
    previous() {
        ...
        this.carouselData.slice(0, 5).forEach((data, index) => {
            document.querySelector(`.carousel-item-${index + 1}`).src =
                data.src;
        });
    }
